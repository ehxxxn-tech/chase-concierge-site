...
const translations = {
  zh: {
    "meta.title":"CHASE | Private Concierge","meta.description":"CHASE禮賓 - 為極少數人服務的私人禮賓。航空、遊艇與豪華座駕的全方位安排。",
    ...
    "hero.eyebrow":"PRIVATE CONCIERGE · 私人禮賓","hero.title":"為極少數人<br />安排的世界","hero.copy":"CHASE禮賓，以絕對的私密與細節，為您統籌航空、遊艇與豪華座駕的每一段行程。","hero.imageAlt":"停於停機坪上的私人飛機，夕陽餘暉映照機身",
    "about.eyebrow":"ABOUT · 關於CHASE","about.title":"低調，<br />是最高的禮遇","about.lead":"CHASE禮賓存在於聚光燈之外。我們不追求規模，只服務於信任我們的少數人。從起飛、登船到抵達目的地前的每一段移動，皆由專屬團隊以最高標準悉心安排。","about.copy":"我們相信，真正的奢華不在於擁有，而在於從容。當您將時間交付於我們，繁瑣自會退場，留下的只有您應得的寧靜、私密與自由。",
    "stats.always":"全天候待命","stats.cities":"全球城市","stats.concierge":"專屬禮賓","stats.limitless":"不設上限",
    "services.eyebrow":"SERVICES · 服務範疇","services.title":"三段行程，皆已備妥","services.copy":"航空、遊艇與陸地豪華座駕，構成 CHASE禮賓的核心移動服務。","services.aviationTitle":"私人航空","services.aviationCopy":"私人飛機與直升機調度，從航線、時段到登機銜接，皆以您的節奏為準。","services.yachtTitle":"遊艇禮遇","services.yachtCopy":"頂級遊艇、專屬船員與航線安排，讓海上的每一刻都成為私人時光。","services.chauffeurTitle":"豪華座駕","services.chauffeurCopy":"專屬司機、禮賓座駕與點對點接送。每一段陸地移動，皆準時、私密且周到。",
  ...
  "hero.eyebrow":"PRIVATE CONCIERGE · プライベートコンシェルジュ","hero.title":"限られた方のために<br />整えられた世界","hero.copy":"CHASEコンシェルジュは、航空、ヨット、ラグジュアリー送迎のすべてを、徹底した機密性と細部への配慮で手配します。",
  "about.eyebrow":"ABOUT · CHASEについて","about.title":"控えめであることこそ<br />最上の礼遇","about.lead":"CHASEコンシェルジュは、華やかな表舞台の外側にあります。規模を追うのではなく、私たちを信頼してくださる限られた方だけにお応えします。離陸、乗船、到着までのすべての移動を、専属チームが高い基準で整えます。","about.copy":"真のラグジュアリーとは所有ではなく、余裕です。お客様の時間をお預けいただくことで、煩雑さは静かに退き、静けさ、プライバシー、自由だけが残ります。",
  "stats.always":"24時間対応","stats.cities":"世界の都市","stats.concierge":"専属コンシェルジュ","stats.limitless":"制限なし",
  "services.eyebrow":"SERVICES · サービス","services.title":"すべての移動を、整えて","services.copy":"航空、ヨット、ラグジュアリー送迎が、CHASEコンシェルジュの中核となる移動サービスです。","services.aviationTitle":"プライベート航空","services.aviationCopy":"プライベートジェットとヘリコプターを、航路、時間、搭乗導線までお客様のペースに合わせて手配します。","services.yachtTitle":"ヨットサービス","services.yachtCopy":"上質なヨット、専属クルー、航路設計により、海上の時間を完全なプライベート空間にします。","services.chauffeurTitle":"ラグジュアリー送迎","services.chauffeurCopy":"専属ドライバーと上質な車両による、時間厳守で静かなポイントツーポイント送迎。",
  ...
  "membership.eyebrow":"MEMBERSHIP · 会員資格","membership.title":"招待によってのみ開かれる扉","membership.copy":"CHASEコンシェルジュは、一人ひとりにふさわしい配慮を保つため会員数を限定しています。会員資格は申請後、個別に審査されます。","membership.planTitle":"尊榮","membership.planCopy":"効率、プライバシー、細部を重視する会員のために。CHASEは 1:1 の専属コンシェルジュが航空、ヨット、ラグジュアリー送迎、提携先での特別待遇を統括します。","membership.benefit1":"1:1 専属コンシェルジュ窓口","membership.benefit2":"プライベート航空とヘリコプター手配","membership.benefit3":"迅速通関とプライベートターミナル調整","membership.benefit4":"世界のヨットと陸上送迎接続","membership.benefit5":"高級車と専属ドライバー","membership.benefit6":"CHASE 提携ブランド特典","membership.benefit7":"会員限定優待と優先予約","membership.apply":"会員申請",
  "contact.eyebrow":"CONTACT · お問い合わせ","contact.title":"専属の対話を<br />始める","contact.copy":"ご連絡先をお残しください。CHASEの会員アドバイザーが24時間以内に直接ご連絡します。情報はすべて厳格に守秘されます。","contact.messaging":"MESSAGING · メッセージ","form.name":"お名前","form.phone":"電話番号","form.email":"メール","form.message":"ご依頼内容","form.namePlaceholder":"ご希望の呼び名","form.phonePlaceholder":"国番号を含めて入力","form.messagePlaceholder":"CHASEに手配を希望される内容を簡潔にご記入ください","form.submit":"申請を送信","footer.copy":"限られた方のために整えられた世界。プライベートコンシェルジュ、絶対的な機密性。","footer.privacy":"プライバシーポリシー","footer.terms":"利用規約"
};
translations.ko = { ...translations.en,
  ...
  "hero.eyebrow":"PRIVATE CONCIERGE · 프라이빗 컨시어지","hero.title":"극소수를 위해<br />준비된 세계","hero.copy":"CHASE 컨시어지는 항공, 요트, 럭셔리 차량 이동의 모든 여정을 철저한 프라이버시와 세심함으로 조율합니다.",
  "about.eyebrow":"ABOUT · CHASE 소개","about.title":"절제된 품격이<br />가장 높은 예우입니다","about.lead":"CHASE 컨시어지는 스포트라이트 밖에 존재합니다. 규모를 좇지 않고, 우리를 신뢰하는 소수의 고객만을 위해 일합니다. 이륙, 승선, 최종 도착까지 모든 이동은 전담 팀이 높은 기준으로 관리합니다.","about.copy":"진정한 럭셔리는 소유가 아니라 여유입니다. 시간을 맡겨 주시면 복잡함은 물러나고, 평온함과 프라이버시, 자유만 남습니다.",
  "stats.always":"24시간 대기","stats.cities":"전 세계 도시","stats.concierge":"전담 컨시어지","stats.limitless":"제한 없음",
  "services.eyebrow":"SERVICES · 서비스","services.title":"모든 이동은 이미 준비되어 있습니다","services.copy":"항공, 요트, 럭셔리 차량 이동은 CHASE 컨시어지의 핵심 모빌리티 서비스입니다.","services.aviationTitle":"프라이빗 항공","services.aviationCopy":"프라이빗 제트와 헬리콥터를 노선, 시간, 탑승 동선까지 고객의 리듬에 맞춰 조율합니다.","services.yachtTitle":"요트 서비스","services.yachtCopy":"최상급 요트, 전담 승무원, 항로 계획으로 바다 위 시간을 온전한 사적 영역으로 만듭니다.","services.chauffeurTitle":"럭셔리 차량 이동","services.chauffeurCopy":"전담 기사와 컨시어지 차량으로 정시성, 프라이버시, 세심함을 갖춘 이동을 제공합니다.",
  ...
  "membership.eyebrow":"MEMBERSHIP · 멤버십","membership.title":"초대받은 분께만 열리는 문","membership.copy":"CHASE 컨시어지는 각 회원에게 충분한 관심을 제공하기 위해 멤버십을 제한적으로 운영합니다. 신청 후 개별 심사가 진행됩니다.","membership.planTitle":"尊榮","membership.planCopy":"효율, 프라이버시, 디테일을 중시하는 회원을 위한 등급입니다. CHASE은 1:1 전담 컨시어지가 항공, 요트, 럭셔리 차량 이동과 파트너 혜택을 통합 관리합니다.","membership.benefit1":"1:1 전담 컨시어지","membership.benefit2":"프라이빗 항공 및 헬리콥터安排","membership.benefit3":"빠른 통관 및 프라이빗 터미널 조율","membership.benefit4":"글로벌 요트와 육상 이동 연결","membership.benefit5":"고급 차량과 전담 기사","membership.benefit6":"CHASE 제휴 브랜드 특별 혜택","membership.benefit7":"회원 전용 혜택 및 우선 예약","membership.apply":"멤버십 신청",
  "contact.eyebrow":"CONTACT · 문의","contact.title":"전담 상담을<br />시작하세요","contact.copy":"연락처를 남겨주시면 CHASE 멤버십 어드바이저가 24시간 이내 직접 연락드립니다. 모든 정보는 엄격히 비밀로 관리됩니다.","contact.messaging":"MESSAGING · 메시지","form.name":"성함","form.phone":"연락처","form.email":"이메일","form.message":"요청 내용","form.namePlaceholder":"어떻게 불러드릴까요?","form.phonePlaceholder":"국가번호 포함","form.messagePlaceholder":"CHASE에 원하시는安排를 간단히 적어주세요","form.submit":"신청 제출","footer.copy":"극소수를 위해 준비된 세계. 프라이빗 컨시어지, 절대적 프라이버시.","footer.privacy":"개인정보 처리방침","footer.terms":"서비스 약관"
};
